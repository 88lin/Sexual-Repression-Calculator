    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card className="sri-card">
        ...
        <CardContent className="space-y-6">
          ...
          {/* 重要提醒 */}
          <Alert className="bg-red-50 border border-red-200/80 p-4 sm:p-5 rounded-2xl shadow-sm flex items-center gap-3">
            <AlertTriangle className="w-5 h-5 sm:w-5 sm:h-5 !text-red-600 flex-shrink-0" />
